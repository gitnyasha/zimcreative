...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/ruby-grape/grape/issues", "changelog_uri" => "https://github.com/ruby-grape/grape/blob/v1.4.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/grape/1.4.0", "source_code_uri" => "https://github.com/ruby-grape/grape/tree/v1.4.0" } if s.respond_to? :metadata=
